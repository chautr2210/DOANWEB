...
if (isset($_GET['viewall'])) {
    ...
    if ($viewall === "Best Seller") { // Kiểm tra xem giá trị tìm kiếm có rỗng hay không
        $viewall = mysqli_real_escape_string($link, $viewall); // Bảo mật giá trị tìm kiếm trước khi sử dụng   
...
if (!empty($viewall)) {
    ...
    echo '<h1 class="search-result" style="color: #000;  text-transform: uppercase;">' .$viewall. '</h1>';
echo'</div>';}
