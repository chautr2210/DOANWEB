...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top " style="height:100px">
  ...
  <a class="icon-right-header1 d-inline-block text-decoration-none  customer-name" href="/account">
    ...
    <div class="banner-collection-header">
        <img src="https://svgur.com/i/tAi.svg" style="width: 100%; height: auto;">
    </div>
    <!-- Best Seller -->
    <div class="best-seller-wrapper">
    <div class="best-seller-head">
        <div class="section-heading d-flex justify-content-between align-items-center">
            <h1 class="section-heading__title">Best Seller</h1>
            <div class="section-heading__more">
            <a href="filter.php?viewall=Best%20Seller" class="btn btn-link" style="color:black">View All</a>
                <svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 0.5L4.5 4L1 7.5" stroke="#2C2C2C" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </div>
        </div>
    </div>
    ...
    <?php include 'bestseller.php'; ?>
      ...
      <!-- Middle Banner -->
    <div class="banner-collection-middle">
        <img src="https://svgur.com/i/tC5.svg" style="width: 100%; height: auto;">
    </div>
    <!-- New Arrival -->
    <div class="new-arrival-wrapper">
        <div class="new-arrival-head">
            <div class="new-arriv-heading d-flex justify-content-between align-items-center">
                <h1 class="new-arriv-heading__title">New Arrival</h1>
                <div class="new-arriv-heading__more">
                    <a href="filter.php?viewall=New%20Arrival" class="btn btn-link" style="color:black">View All</a>
                    <svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 0.5L4.5 4L1 7.5" stroke="#2C2C2C" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
